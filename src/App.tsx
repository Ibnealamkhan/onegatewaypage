...
function App() {
  ...
  const handleContactButtonClick = (location: string) => {
    trackButtonClick('Contact Us', location);
    trackModalOpen('Contact Form');
  ...
  const clients = [
    ...
    { name: "BillPe", logo: "https://play-lh.googleusercontent.com/QRh3SOM1KJv2S2IPWYfJH4cHBEADpgCc5sXWYI7TW4nGAFya0DFBn-TETFvWNqMWTyk", color: "bg-rose-600", description: "Bill Payment Solutions" , url: "https://billpe.app/", isImage: true, isExternalImage: true},
